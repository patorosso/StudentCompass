...
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'TestDbStudentCompass')
BEGIN
	DROP DATABASE TestDbStudentCompass
END

GO

-- Database creation
CREATE DATABASE TestDbStudentCompass

GO

USE TestDbStudentCompass
