...
INSERT INTO Student (Username, Pass, IsActive) VALUES ('admin', 'admin', 1);

insert into Enrolled (CareerPlanId, StudentId, EnrollmentYear) values (1,1,2022)

-- insert some rows into course, with student id 1

INSERT INTO Course 
(StudentId, SubjectCode, CareerPlanId, TermId, StatusId, Year, FinalGrade) VALUES
